...
Снимок реальной конфигурации сервера на 2026-06-21.
...
| **3000/tcp** | **geo-bot app ⚠️ — публично, без Nginx** |
...
| **geo-bot-app-1** | **geo-bot:latest** | **`0.0.0.0:3000->3000` ⚠️** |
| geo-bot-postgres-1 | postgres:16-alpine | — |
| geo-bot-redis-1 | redis:7-alpine | — |

> ⚠️ `geo-bot-app-1` публично слушает на `0.0.0.0:3000` — UFW-правило отсутствует или не ограничивает.
...
|-----------|----------|----------|
| 🟠 Высокий | `geo-bot-app-1` слушает на `0.0.0.0:3000` без Nginx-прокси | Добавить UFW-правило `deny 3000` или поставить перед Nginx |
